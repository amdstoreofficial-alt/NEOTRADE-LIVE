    ...
    sections: [
      {
        ...
        content: `By accessing or using the NEOTRADE Trading Platform ("Platform"), you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the Platform. The Platform is operated by NEOTRADE Ltd. and provides binary options trading services for forex, cryptocurrencies, and precious metals.`
      },
      {
        title: '2. Eligibility',
      ...
      {
        title: '10. Contact',
        content: `For questions about these Terms, contact: support@neotrade.live`
      }
    ]
  },
  privacy: {
    ...
    sections: [
      ...
      {
        title: '10. Contact',
        content: `Data Protection Officer: privacy@neotrade.live`
      }
    ]
  },
  risk: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: `NEOTRADE does not provide investment advice. AI predictions and market analysis are for informational purposes only and should not be considered recommendations. You are solely responsible for your trading decisions.`
      },
      {
      ...
      },
      {
        ...
        content: `By using NEOTRADE, you acknowledge: You have read and understood these risks; You have sufficient knowledge and experience; You accept full responsibility for your decisions; You will not hold NEOTRADE liable for trading losses.`
      },
      {
