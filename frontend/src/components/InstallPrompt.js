...
const InstallPrompt = () => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="bg-[#0F0F1F]/95 backdrop-blur-xl border border-brand/20 rounded-2xl p-4 shadow-[0_0_40px_rgba(139,92,246,0.18)]">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between mb-1">
                <h3 className="text-sm font-bold text-white">Install NEOTRADE</h3>
                <button
              ...
              {!isIOS && deferredPrompt ? (
                <button
                  ...
                  className="w-full py-2.5 rounded-xl bg-gradient-brand text-white text-xs font-bold flex items-center justify-center gap-2 transition-all hover:shadow-[0_0_20px_rgba(139,92,246,0.45)]"
